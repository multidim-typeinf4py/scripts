...
from src.common import transformers as t
from src.common.metadata.anno4inst import Annotation4InstanceProvider
from src.common.visitors import (
...
class MultiVarTypeCollector(
    ...
    def _handle_NameOrAttribute(
        ...
        qualified_node = (
            libcst.parse_module(qualified_name)
